...
const Mentions = () => {
  return (
    <div className="w-full flex items-center justify-center min-h-[calc(100vh-270px)]">
      <div className="max-w-4xl mx-auto px-4 py-8 ">
        <h2 className="text-2xl font-bold mb-4">Mentions légales et politique de confidentialité</h2>
        <p className="mb-4">
          La société <strong>Thé tip top</strong>, soucieuse des droits des individus, notamment au regard des
          traitements automatisés et dans une volonté de transparence avec ses clients, a mis en place une politique
          reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens
