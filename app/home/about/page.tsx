    ...
    <>
      ...
      <div className="bg-gray-100 min-h-screen py-12">
        <div className="container mx-auto px-4 lg:px-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#8FB43A] text-center mb-8">À Propos de Thé Tip Top</h1>

          <article className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-[#8FB43A] text-center mb-6">Notre Mission</h2>
            ...
            <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold text-[#8FB43A] text-center mb-4">Qualité et Durabilité</h3>
            <p className="text-base md:text-lg text-gray-700 mb-6">
            ...
            <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold text-[#8FB43A] text-center mb-4">Notre Présence à Nice</h3>
            <p className="text-base md:text-lg text-gray-700 mb-6">
            ...
            <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold text-[#8FB43A] text-center mb-4">Participez à Notre Jeu-Concours</h3>
            <p className="text-base md:text-lg text-gray-700 mb-6">
