...
const CardItem = ({ date, gift }) => {
  ...
  return (
    <div ref={ref} className="grid-item transform transition duration-500 ease-in-out hover:scale-105">
      ...
      <p
        className={`status mt-3 ${
          gift.status === 'Remis' ? 'text-green-600' : gift.status === 'En attente' ? 'text-yellow-600' : 'text-red-600'
        }`}
      >
        {`Statut: ${gift.status}`}
      </p>
